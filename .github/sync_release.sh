...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Aquarius_MISTer.git"
CORE_NAME=(Aquarius)
...
UPSTREAM_CORE_NAME=(Aquarius)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Aquarius.qpf)
COMPILATION_OUTPUT=(output_files/Aquarius.rbf)
